 ...
 */
 ...
 {
  CommandLine cmd;
  std::string cacheSize = "1";
  std::string Frequency = "100";
  std::string NumberOfContents = "200";
  cmd.AddValue("cacheSize", "Cache size of contents routers.", cacheSize);
  cmd.AddValue("Frequency", "Frequency of Interest Packet.", Frequency);
  cmd.AddValue("NumberOfContents", "Number of contents.", NumberOfContents);
  ...
  //Consumer application of Movie
    ...
    std::string HalfFrequency = std::to_string(std::stoi(Frequency)/2);
   ...
   consumerHelper.SetPrefix("/Movie");
    ...
    consumerHelper.SetAttribute("Frequency", StringValue(HalfFrequency));
